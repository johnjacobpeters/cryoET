...
for i=1:size(fsc.data(:,2),1)
    if fsc.data(i,2)<0.141
        v1=fsc.data(i-1,1);
        v2=fsc.data(i,1);
        v=(v1+v2)./2;
%     
        text(0,0.141,sprintf('  %0.3g A >>>',1./v));
        v_141=v;
        break;
    end;
end;
...
title(['FSC, Ny@' num2str(fsc.data(end,4)) ' Ang. FSC: 0.5@' sprintf('%0.3g',1./v_05) ' A, 0.3@' sprintf('%0.3g',1./v_03) ' A. 0.141@'  sprintf('%0.3g',1./v_141) ' A.']);
[a b c]=fileparts(filename);
set(fig,'Name',[b c]);
