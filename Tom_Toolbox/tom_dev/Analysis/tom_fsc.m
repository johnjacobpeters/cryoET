function [fsc,f,v_05,v_03,v_014]=tom_fsc(vol1,vol2,nr_shells,objectpixelsize,display,wedge)
...
%   f                   frequencies
%   v_05, v_03, v_014    0.5, 0.3 and 0.14 threshould criteria
%
%
%EXAMPLE
%   Example:
...
if (sz3>1)
    ...
    vol1_fft = fftshift(fftn(vol1,[nr_shells nr_shells ]));
    vol2_fft_conj = fftshift(conj(fftn(vol2,[nr_shells nr_shells])));
end;
...
if (sz3>1)
    ...
    vol1_fft =vol1_fft./(sz*sz);
    vol2_fft_conj =vol2_fft_conj./(sz*sz);
end;
